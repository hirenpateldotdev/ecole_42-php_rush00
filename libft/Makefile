...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/12/17 15:35:01 by hirenpat          #+#    #+#              #
#    Updated: 2018/12/17 15:35:05 by hirenpat         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILENAME	+= ft_strrev.c ft_strlen.c ft_strdup.c ft_strcpy.c ft_strncpy.c ft_strcat.c ft_strncat.c ft_strlcat.c ft_strchr.c ft_strrchr.c ft_strstr.c ft_strnstr.c ft_strcmp.c ft_strncmp.c ft_strupcase.c ft_strlowcase.c ft_strcapitalize.c
FILENAME	+= ft_atoi.c ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_toupper.c ft_tolower.c ft_str_is_alpha.c ft_str_is_numeric.c ft_str_is_lowercase.c ft_str_is_uppercase.c ft_str_is_printable.c
